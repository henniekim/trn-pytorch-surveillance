...
def return_moments(modality):
    filename_categories = '/datahdd/workdir/donghyun/TRN-pytorch/crime_categories.txt'
    if modality == 'RGB':
        prefix = 'img_{:05d}.jpg'
        root_data = '/datahdd/Dataset/UCF_Crimes/processed'
        filename_imglist_train = '/datahdd/workdir/donghyun/TRN-pytorch/train_videofolder.txt'
        filename_imglist_val = '/datahdd/workdir/donghyun/TRN-pytorch/val_videofolder.txt'
